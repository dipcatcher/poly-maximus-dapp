...
def get_contract_details(ticker):
  tokens = {
    "POLY": {
      'address' :"0x803955E0a278bc6642c4333973685888CbFF961f",
      'abi' : [
        	{
        		"inputs": [
        			{
        	...
        	{
        		"inputs": [],
        		"name": "LAST_POSSIBLE_MINTING_DAY",
        		"outputs": [
        			{
        				"internalType": "uint256",
        				"name": "",
    ...
    "WATER": {
      'address' :"0x5eE8FBfA076B69DdAb59Ed85183c6fb34122F612",
      'abi' : [
	{
		"inputs": [
			{
