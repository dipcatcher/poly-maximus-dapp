...
def get_prices():
  ...
  print('urls')
  icsa_prices = api.get_pool_prices(icsa_pool)
  hdrn_prices = api.get_pool_prices(icsa_pool)
  poly_prices = api.get_pool_prices(icsa_pool)
  hex_prices = api.get_pool_prices(icsa_pool)
  all_prices = {}
